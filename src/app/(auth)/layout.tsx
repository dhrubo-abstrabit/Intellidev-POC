...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    // theme-forced-light pins this subtree to the light semantic-token
    // values regardless of the app-wide dark toggle/system preference — a
    // nested next-themes ThemeProvider can't do this, it's a no-op once
    // already inside another provider's context (see globals.css). bg-
    // background paints over whatever <body> resolved to under dark mode,
    // since this div would otherwise stay transparent and let it show
    // through on the right-hand column.
    //
    ...
    <div className="theme-forced-light flex h-screen overflow-hidden bg-background text-foreground">
