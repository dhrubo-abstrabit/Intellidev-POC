...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    // Nested provider forces light mode here regardless of the app-wide
    // toggle/system preference (next-themes' documented pattern for pinning
    // a subtree's theme) — this panel's design is fixed brand-teal/white and
    // isn't meant to react to dark mode.
